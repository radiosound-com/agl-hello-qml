# This project doesn't need to "compile" anything. If TEMPLATE = aux is
# left out and you try to build hello_qml.pro for desktop to test the UI,
# Qt will try to compile package.pro and will be missing a main().
TEMPLATE = aux
...
# Make the .wgt
wgt.target = package
wgt.commands = wgtpkg-pack -f -o hello_qml.wgt root

QMAKE_EXTRA_TARGETS += wgt

# Copy the .wgt to /home/root
pkg.path = /home/root
pkg.files = hello_qml.wgt
